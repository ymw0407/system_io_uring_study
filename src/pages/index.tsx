...
export default function Landing() {
  return (
    <>
      ...
      <StepSection title="Study Parts" id="parts">
        <StepCard
          step={1}
          kind="setup"
          label="PART 1 — 도입과 배경"
          title="io_uring과 PAS/DPAS 이해하기"
          description="전통적 read()의 비용 구조부터 io_uring의 공유 링 버퍼, 그리고 PAS/DPAS와의 비용 축 분리까지. 이후 모든 회차의 narrative가 의존하는 framework를 정리한다."
          tools={['mmap', 'SQ/CQ', 'mode/context switch', 'IOPOLL vs SQPOLL']}
          href="/part1"
        />
